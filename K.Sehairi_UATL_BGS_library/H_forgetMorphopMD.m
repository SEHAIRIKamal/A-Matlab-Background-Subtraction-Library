...
% forgetting morphological operators applied on gray level images
clear all
close all
clc
...
%             end
            ...
            MaxBG=max(I,MaxBackground);
            minBG=min(I,minBackground);
            
  			MaxBackground = (alpha * I) +((1-alpha)* MaxBG);
            minBackground = (alpha * I) +((1-alpha)* minBG);
        end
        S=MaxBackground-minBackground;
